...
bool GraphGenerator::check_probability(double chance) const {
...
Graph::VertexId GraphGenerator::get_random_vertex_id(int size) const {
...
void GraphGenerator::try_generate_green_edge(Graph& graph,
                                             Graph::VertexId vertex_id) const {
